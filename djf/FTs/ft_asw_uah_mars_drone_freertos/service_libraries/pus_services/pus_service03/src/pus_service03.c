...
HK_config_t HKConfig[PUS_SERVICE3_MAX_NUM_OF_SIDS] = {
		{ SIDDisabled, 0, 3, 0, 6, { 0, 1, 2, 3, 4, UAH_DRONE_Wind, 0, 0, 0, 0, 0, 0 } },
		{ SIDDisabled, 10, 3, 0, 6, { UAH_DRONE_X, UAH_DRONE_Y, UAH_DRONE_Z, UAH_DRONE_VX, UAH_DRONE_VY, UAH_DRONE_VZ, 0, 0, 0, 0, 0, 0 } },
