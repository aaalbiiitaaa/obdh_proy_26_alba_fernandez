...
EmuGSS_TCProgram12_1 prog_FT_1020_step_3(FT_1020_TIME_step3,
					"IT_UAH_DRONE_FDIR_1020 step 3, Enable Monitoring PMODID 0",
					0);

EmuGSS_TCProgram129_2 prog_IT_1020_step_4(FT_1020_TIME_step4,
		"IT_UAH_DRONE_FDIR_1020 step 4, Set PID Params to 0.2, 0.15, 0.05",0.2,0.15,0.05);

EmuGSS_TCProgram129_1 prog_IT_1020_step_5(FT_1020_TIME_step5,
		"IT_UAH_DRONE_FDIR_1020 step 5, Set Flight Plan x=150.5, y=90.5, z=30.2",150.5,90.5,30.2);

EmuGSS_TCProgram129_3 prog_IT_1020_step_6(FT_1020_TIME_step6,
		"IT_UAH_DRONE_FDIR_1020 step 6, Exec Flight Plan");
